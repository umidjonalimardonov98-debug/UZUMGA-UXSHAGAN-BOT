...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Baraka Shop — onlayn kiyim-kechak do'koni. Tez yetkazib berish." },
      { name: "author", content: "Baraka Shop" },
      { property: "og:title", content: "Baraka Shop — kiyim-kechak do'koni" },
      { property: "og:description", content: "Baraka Shop — onlayn kiyim-kechak do'koni. Tez yetkazib berish." },
